...
import { FiLogOut, FiLogIn, FiPlus, FiLoader, FiStar, FiMenu, FiX, FiUser, FiHome } from 'react-icons/fi';
...
const Header = () => {
    ...
    return (
        <>
            <Disclosure as="header" className="bg-aida-card/80 backdrop-blur-md border-b border-aida-border sticky top-0 z-50">
                {({ open, close }) => (
                    <>
                                        ...
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div className="hidden sm:block">
                                                <Menu as="div" className="relative ml-3">
                                                    ...
                                                    >
                                                        <Menu.Items className="absolute right-0 w-48 mt-2 origin-top-right bg-white border border-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none py-1">
                                                            <div className="px-4 py-2 border-b border-gray-100">
                                                                <p className="text-sm text-gray-500">Signed in as</p>
                                                                <p className="text-sm font-medium text-gray-900 truncate">{user.name}</p>
                                                                <p className="text-xs text-gray-500 truncate">{user.email || 'User Account'}</p>
                                                            </div>
                                                            <Menu.Item>
                                                                {({ active }) => (
                                                                    <Link
                                                                        to="/dashboard"
                                                                        className={`${active ? 'bg-gray-50 text-aida-pink' : 'text-gray-700'} flex items-center px-4 py-2 text-sm transition-colors`}
                                                                    >
                                                            ...
                                                            <Menu.Item>
                                                                {({ active }) => (
                                                                    <button
                                                                        ...
                                                                        className={`${active ? 'bg-gray-50 text-red-600' : 'text-gray-700'} flex w-full items-center px-4 py-2 text-sm transition-colors`}
                                                                    >
                                            ...
                                            <div className="flex sm:hidden">
                                                <Disclosure.Button className="inline-flex items-center justify-center p-2 text-gray-400 rounded-md hover:text-aida-pink hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-aida-pink">
                        ...
                        <Disclosure.Panel className="sm:hidden bg-white border-t border-gray-100 shadow-lg absolute w-full z-50">
                            {isAuthenticated && user && (
                                <div className="pt-4 pb-3 border-t border-gray-200">
                                    ...
                                    <div className="px-2 mt-3 space-y-1">
                                        ...
                                        <Disclosure.Button
                                            as="button"
                                            onClick={handleLogout}
                                            className="flex items-center w-full px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:text-red-600 hover:bg-gray-50"
                                        >
